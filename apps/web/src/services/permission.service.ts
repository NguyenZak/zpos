...
export const DEFAULT_PERMISSIONS: Permission[] = [
  // ===== Tổng quan =====
  {
    ...
    description: "Truy cập trang Dashboard và các thẻ số liệu tổng quan",
  },
  {
    id: "dashboard.revenue.view",
    name: "Xem doanh thu trên Dashboard",
    group_name: "Tổng quan",
    description: "Hiển thị số liệu doanh thu, doanh số trên Dashboard",
  },
  {
    id: "dashboard.profit.view",
    name: "Xem lợi nhuận trên Dashboard",
    group_name: "Tổng quan",
    description: "Hiển thị số liệu lợi nhuận / giá vốn trên Dashboard (quyền nhạy cảm)",
  },

  // ===== POS / Bán hàng tại quầy =====
  {
    id: "pos.access",
    name: "Truy cập màn hình POS",
    group_name: "POS - Bán hàng",
    description: "Mở màn hình bán hàng tại quầy",
  },
  {
    id: "pos.sell",
    name: "Tạo đơn & thanh toán",
    group_name: "POS - Bán hàng",
    description: "Chọn hàng, thanh toán và chốt đơn tại quầy",
  },
  {
    id: "pos.price.override",
    name: "Sửa giá bán tại quầy",
    group_name: "POS - Bán hàng",
    description: "Chỉnh giá bán của sản phẩm ngay trên màn hình POS",
  },
  {
    id: "pos.discount.apply",
    name: "Áp dụng giảm giá",
    group_name: "POS - Bán hàng",
    description: "Áp dụng giảm giá theo % hoặc số tiền cho đơn POS",
  },
  {
    id: "pos.discount.approve",
    name: "Duyệt giảm giá vượt ngưỡng",
    group_name: "POS - Bán hàng",
    description: "Phê duyệt phiếu giảm giá vượt ngưỡng cho phép của thu ngân",
  },
  {
    id: "pos.void_item",
    name: "Hủy dòng sản phẩm trong đơn",
    group_name: "POS - Bán hàng",
    description: "Bỏ một dòng hàng khỏi đơn đang lập",
  },
  {
    id: "pos.cancel_order",
    name: "Hủy đơn đang lập",
    group_name: "POS - Bán hàng",
    description: "Hủy bỏ toàn bộ đơn hàng đang lập tại quầy",
  },
  {
    id: "pos.refund",
    name: "Hoàn tiền tại quầy",
    group_name: "POS - Bán hàng",
    description: "Thực hiện hoàn tiền cho khách ngay tại màn hình POS",
  },
  {
    id: "pos.print_receipt",
    name: "In hóa đơn",
    group_name: "POS - Bán hàng",
    description: "In hoặc xuất hóa đơn cho khách sau khi chốt đơn",
  },
  {
    id: "pos.reprint_receipt",
    name: "In lại hóa đơn cũ",
    group_name: "POS - Bán hàng",
    description: "In lại hóa đơn cho đơn hàng đã hoàn tất",
  },
  ...
  // ===== Ca làm việc & Quầy thu ngân =====
  {
    ...
    group_name: "Ca làm việc",
    description: "Xem danh sách ca làm và lịch sử mở/đóng ca",
  },
  {
    id: "shifts.open",
    name: "Mở ca làm việc",
    group_name: "Ca làm việc",
    description: "Tạo phiên ca mới với số dư đầu ca",
  },
  {
    id: "shifts.close",
    name: "Đóng ca làm việc",
    group_name: "Ca làm việc",
    description: "Chốt số liệu cuối ca và nộp tiền quầy",
  },
  {
    id: "shifts.cash_in",
    name: "Thu tiền vào quầy",
    group_name: "Ca làm việc",
    description: "Ghi nhận thu tiền mặt phát sinh trong ca",
  },
  {
    id: "shifts.cash_out",
    name: "Chi tiền từ quầy",
    group_name: "Ca làm việc",
    description: "Ghi nhận chi tiền mặt phát sinh trong ca",
  },
  {
    id: "shifts.adjust",
    name: "Điều chỉnh chênh lệch quỹ",
    group_name: "Ca làm việc",
    description: "Quyền duyệt chênh lệch số tiền cuối ca (quyền nhạy cảm)",
  },
  ...
  },
  {
    ...
    group_name: "Sản phẩm",
    description: "Xem trang chi tiết của một sản phẩm",
  },
  {
    id: "products.create",
  ...
  },
  {
    ...
    group_name: "Sản phẩm",
    description: "Chỉnh sửa thông tin sản phẩm có sẵn",
  },
  {
    id: "products.delete",
    name: "Xóa sản phẩm",
    group_name: "Sản phẩm",
    description: "Xóa sản phẩm khỏi hệ thống (quyền nhạy cảm)",
  },
  {
    id: "products.import",
    name: "Nhập sản phẩm từ Excel",
    group_name: "Sản phẩm",
    description: "Tải lên file Excel/CSV để thêm hàng loạt sản phẩm",
  },
  {
    id: "products.export",
    name: "Xuất sản phẩm ra Excel",
    group_name: "Sản phẩm",
    description: "Xuất danh sách sản phẩm ra file Excel/CSV",
  },
  {
    id: "products.price.update",
    name: "Cập nhật giá bán",
    group_name: "Sản phẩm",
    description: "Thay đổi giá bán của sản phẩm",
  },
  {
    id: "products.cost.view",
    name: "Xem giá vốn",
    group_name: "Sản phẩm",
    description: "Xem giá vốn / giá nhập của sản phẩm (quyền nhạy cảm)",
  },
  {
    id: "products.cost.update",
    name: "Cập nhật giá vốn",
    group_name: "Sản phẩm",
    description: "Thay đổi giá vốn / giá nhập của sản phẩm (quyền nhạy cảm)",
  },
  { id: "products.barcode.scan", name: "Quét mã vạch", group_name: "Sản phẩm", description: "Quét mã vạch sản phẩm" },
  {
    id: "products.barcode.generate",
    name: "Tạo mã vạch",
    group_name: "Sản phẩm",
    description: "Tự động tạo mã vạch cho sản phẩm",
  },
  {
    id: "products.barcode.update",
    name: "Cập nhật mã vạch",
    group_name: "Sản phẩm",
    description: "Cập nhật mã vạch cho sản phẩm / phiên bản",
  },
  {
    id: "products.barcode.print",
    name: "In tem mã vạch",
    group_name: "Sản phẩm",
    description: "In tem nhãn mã vạch cho sản phẩm",
  },
  ...
  },
  {
    ...
    group_name: "Danh mục",
    description: "Chỉnh sửa tên / cấu trúc danh mục",
  },
  ...
  // ===== Tồn kho =====
  {
    ...
    name: "Xem tồn kho",
    group_name: "Tồn kho",
    description: "Xem số lượng tồn theo từng chi nhánh",
  },
  {
    id: "inventory.history.view",
    name: "Xem lịch sử nhập / xuất kho",
    group_name: "Tồn kho",
    description: "Xem toàn bộ phát sinh nhập xuất kho",
  },
  {
    id: "inventory.adjust",
    name: "Điều chỉnh tồn kho",
    group_name: "Tồn kho",
    description: "Tăng / giảm tồn thủ công kèm lý do (quyền nhạy cảm)",
  },
  {
    id: "inventory.transfer",
    name: "Chuyển kho giữa chi nhánh",
    group_name: "Tồn kho",
    description: "Tạo phiếu chuyển kho qua lại giữa các chi nhánh",
  },
  {
    id: "inventory.audit",
    name: "Kiểm kê kho",
    group_name: "Tồn kho",
    description: "Tạo phiếu kiểm kê và cân đối tồn",
  },
  {
    id: "inventory.threshold.manage",
    name: "Cấu hình tồn kho tối thiểu",
    group_name: "Tồn kho",
    description: "Thiết lập định mức cảnh báo tồn kho cho từng sản phẩm",
  },
  {
    id: "inventory.import",
    name: "Nhập tồn từ file",
    group_name: "Tồn kho",
    description: "Nhập tồn kho ban đầu từ file Excel/CSV",
  },
  {
    id: "inventory.export",
    name: "Xuất tồn kho ra Excel",
    group_name: "Tồn kho",
    description: "Xuất số liệu tồn kho ra file",
  },
  ...
  // ===== Đơn hàng =====
  {
    ...
    group_name: "Đơn hàng",
    description: "Xem danh sách hóa đơn đã chốt",
  },
  {
    id: "orders.detail.view",
    name: "Xem chi tiết hóa đơn",
    group_name: "Đơn hàng",
    description: "Xem chi tiết dòng hàng / thanh toán của hóa đơn",
  },
  {
    id: "orders.create",
    name: "Tạo hóa đơn ngoài quầy",
    group_name: "Đơn hàng",
    description: "Tạo hóa đơn từ trang quản lý đơn (không qua POS)",
  },
  {
    id: "orders.update",
    name: "Cập nhật hóa đơn",
    group_name: "Đơn hàng",
    description: "Chỉnh sửa thông tin / dòng hàng hóa đơn",
  },
  {
    id: "orders.cancel",
    name: "Hủy hóa đơn đã chốt",
    group_name: "Đơn hàng",
    description: "Hủy hóa đơn sau khi đã chốt (quyền nhạy cảm)",
  },
  {
    id: "orders.delete",
    name: "Xóa hóa đơn",
    group_name: "Đơn hàng",
    description: "Xóa cứng hóa đơn khỏi hệ thống (quyền nhạy cảm)",
  },
  {
    id: "orders.refund",
    name: "Hoàn tiền hóa đơn",
    group_name: "Đơn hàng",
    description: "Tạo phiếu hoàn tiền cho hóa đơn đã chốt",
  },
  {
    id: "orders.discount.approve",
    name: "Duyệt giảm giá hóa đơn",
    group_name: "Đơn hàng",
    description: "Phê duyệt giảm giá vượt ngưỡng trên hóa đơn",
  },
  { id: "orders.print", name: "In / tải hóa đơn", group_name: "Đơn hàng", description: "In lại hoặc tải PDF hóa đơn" },
  {
    id: "orders.print_temp",
    name: "In tạm tính",
    group_name: "Đơn hàng",
    description: "In hóa đơn tạm tính trước khi thanh toán",
  },
  {
    id: "orders.print_final",
    name: "In hóa đơn thanh toán",
    group_name: "Đơn hàng",
    description: "In hóa đơn chính thức sau thanh toán",
  },
  {
    id: "orders.print_kitchen",
    name: "In phiếu bếp",
    group_name: "Đơn hàng",
    description: "In phiếu yêu cầu chế biến xuống bếp",
  },
  {
    id: "orders.print_bar",
    name: "In phiếu bar",
    group_name: "Đơn hàng",
    description: "In phiếu yêu cầu pha chế xuống quầy bar",
  },
  {
    id: "orders.export",
    name: "Xuất danh sách hóa đơn",
    group_name: "Đơn hàng",
    description: "Xuất hóa đơn ra file Excel/CSV",
  },

  // ===== Trả hàng =====
  {
    id: "returns.view",
    name: "Xem phiếu trả hàng",
    group_name: "Trả hàng",
    description: "Xem danh sách phiếu trả hàng",
  },
  {
    id: "returns.create",
    name: "Tạo phiếu trả hàng",
    group_name: "Trả hàng",
    description: "Khởi tạo phiếu trả hàng từ khách",
  },
  {
    id: "returns.update",
    name: "Cập nhật phiếu trả",
    group_name: "Trả hàng",
    description: "Chỉnh sửa thông tin / dòng hàng trên phiếu trả",
  },
  {
    id: "returns.approve",
    name: "Duyệt phiếu trả hàng",
    group_name: "Trả hàng",
    description: "Phê duyệt phiếu trả hàng",
  },
  {
    id: "returns.refund",
    name: "Hoàn tiền cho khách",
    group_name: "Trả hàng",
    description: "Ghi nhận hoàn tiền cho phiếu trả",
  },
  ...
  { id: "customers.view", name: "Xem khách hàng", group_name: "Khách hàng", description: "Xem danh sách khách hàng" },
  {
    ...
    description: "Xem hồ sơ chi tiết của một khách hàng",
  },
  {
    id: "customers.create",
  ...
  },
  {
    ...
    group_name: "Khách hàng",
    description: "Hợp nhất các hồ sơ khách hàng bị trùng",
  },
  {
    id: "customers.import",
    name: "Nhập khách hàng từ Excel",
    group_name: "Khách hàng",
    description: "Tải lên file để thêm khách hàng hàng loạt",
  },
  {
    id: "customers.export",
    name: "Xuất khách hàng ra Excel",
    group_name: "Khách hàng",
    description: "Xuất danh sách khách hàng ra file",
  },
  {
    id: "customers.debt.view",
    name: "Xem công nợ khách hàng",
    group_name: "Khách hàng",
    description: "Xem số dư công nợ của từng khách hàng",
  },
  {
    id: "customers.debt.collect",
    name: "Thu công nợ khách hàng",
    group_name: "Khách hàng",
    description: "Ghi nhận thu nợ từ khách hàng",
  },
  ...
  },
  {
    ...
    group_name: "Nhà cung cấp",
    description: "Xóa hồ sơ nhà cung cấp",
  },
  {
    id: "suppliers.debt.view",
    name: "Xem công nợ NCC",
    group_name: "Nhà cung cấp",
    description: "Xem số dư công nợ với nhà cung cấp",
  },
  {
    id: "suppliers.debt.pay",
    name: "Thanh toán công nợ NCC",
    group_name: "Nhà cung cấp",
  ...
  // ===== Nhập hàng =====
  {
    ...
    group_name: "Nhập hàng",
    description: "Xem danh sách đơn đặt hàng nhập",
  },
  {
    id: "purchases.create",
  ...
  },
  {
    ...
    name: "Duyệt đơn nhập",
    group_name: "Nhập hàng",
    description: "Phê duyệt đơn nhập trước khi đặt hàng NCC",
  },

  // ===== Tài chính =====
  {
    id: "finance.overview.view",
    name: "Xem tổng quan tài chính",
    group_name: "Tài chính",
    description: "Truy cập trang tổng quan tài chính",
  },
  {
    id: "finance.cashflow.view",
    name: "Xem dòng tiền",
    group_name: "Tài chính",
    description: "Xem báo cáo dòng tiền vào / ra",
  },
  {
    id: "finance.cashflow.create",
    name: "Ghi nhận giao dịch dòng tiền",
    group_name: "Tài chính",
    description: "Tạo bản ghi thu / chi vào dòng tiền",
  },
  {
    id: "finance.expenses.view",
    name: "Xem chi phí",
    group_name: "Tài chính",
    description: "Xem danh sách chi phí của doanh nghiệp",
  },
  {
    id: "finance.expenses.create",
    name: "Ghi nhận chi phí",
    group_name: "Tài chính",
    description: "Thêm chi phí phát sinh mới",
  },
  {
    id: "finance.expenses.delete",
    name: "Xóa chi phí",
    group_name: "Tài chính",
    description: "Xóa bản ghi chi phí (quyền nhạy cảm)",
  },
  {
    id: "finance.recurring.view",
    name: "Xem chi phí định kỳ",
    group_name: "Tài chính",
    description: "Xem các khoản chi phí định kỳ tự động",
  },
  {
    id: "finance.recurring.manage",
    name: "Quản lý chi phí định kỳ",
    group_name: "Tài chính",
    description: "Tạo / cập nhật / xóa khoản chi phí định kỳ",
  },
  {
    id: "finance.profit.view",
    name: "Xem lợi nhuận",
    group_name: "Tài chính",
    description: "Truy cập báo cáo lợi nhuận & lỗ (quyền nhạy cảm)",
  },
  {
    id: "finance.payroll.view",
    name: "Xem bảng lương",
    group_name: "Tài chính",
    description: "Xem bảng lương nhân viên (quyền nhạy cảm)",
  },
  {
    id: "finance.payroll.manage",
    name: "Quản lý bảng lương",
    group_name: "Tài chính",
    description: "Tạo và chốt bảng lương nhân viên",
  },
  {
    id: "finance.bank_accounts.manage",
    name: "Quản lý tài khoản ngân hàng",
    group_name: "Tài chính",
    description: "Thêm / sửa / xóa tài khoản ngân hàng nhận tiền",
  },
  ...
  // ===== Hóa đơn điện tử =====
  {
    ...
    group_name: "Hóa đơn điện tử",
    description: "Xem danh sách hóa đơn điện tử đã phát hành",
  },
  {
    id: "einvoice.issue",
  ...
  },
  {
    ...
    group_name: "Hóa đơn điện tử",
    description: "Cấu hình kết nối nhà cung cấp HĐĐT",
  },
  ...
  // ===== Thanh toán VietQR =====
  {
    ...
    group_name: "Thanh toán VietQR",
    description: "Xem lịch sử giao dịch chuyển khoản / VietQR",
  },
  {
    id: "payments.refund",
    name: "Hoàn tiền giao dịch",
    group_name: "Thanh toán VietQR",
    description: "Ghi nhận hoàn tiền cho giao dịch VietQR",
  },
  {
    id: "payments.configure",
    name: "Cấu hình cổng thanh toán",
    group_name: "Thanh toán VietQR",
    description: "Thiết lập tài khoản nhận VietQR / webhook",
  },

  // ===== Báo cáo =====
  {
    id: "reports.dashboard.view",
    name: "Báo cáo tổng quan",
    group_name: "Báo cáo",
    description: "Báo cáo doanh thu / hoạt động tổng hợp",
  },
  {
    id: "reports.sales.view",
    name: "Báo cáo bán hàng",
    group_name: "Báo cáo",
    description: "Báo cáo chi tiết doanh thu, sản phẩm bán chạy",
  },
  {
    id: "reports.product.view",
    name: "Báo cáo sản phẩm",
    group_name: "Báo cáo",
    description: "Báo cáo tồn kho, sản phẩm theo thời gian",
  },
  {
    id: "reports.inventory.view",
    name: "Báo cáo kho",
    group_name: "Báo cáo",
    description: "Báo cáo nhập / xuất / tồn kho chi tiết",
  },
  {
    id: "reports.staff.view",
    name: "Báo cáo nhân viên",
    group_name: "Báo cáo",
    description: "Báo cáo doanh số theo nhân viên",
  },
  {
    id: "reports.export",
    name: "Xuất báo cáo",
    group_name: "Báo cáo",
    description: "Xuất file PDF / Excel cho mọi báo cáo",
  },
  ...
  // ===== Nhân viên =====
  {
    ...
    description: "Xem danh sách nhân viên trong tổ chức",
  },
  {
    id: "staff.create",
    name: "Tạo nhân viên",
    group_name: "Nhân viên",
    description: "Cấp tài khoản đăng nhập cho nhân viên mới",
  },
  {
    id: "staff.update",
  ...
  },
  {
    ...
    name: "Khóa nhân viên",
    group_name: "Nhân viên",
    description: "Tạm ngưng / khóa tài khoản nhân viên",
  },
  {
    id: "staff.assign_role",
    name: "Gán vai trò",
    group_name: "Nhân viên",
    description: "Gán vai trò truy cập cho nhân viên",
  },
  {
    id: "staff.permissions.manage",
    name: "Quản lý phân quyền",
    group_name: "Nhân viên",
    description: "Tạo vai trò tùy chỉnh và gán quyền hạn (chỉ Owner)",
  },
  ...
  // ===== Vai trò & phân quyền =====
  {
    id: "roles.view",
    name: "Xem vai trò",
    group_name: "Vai trò & Phân quyền",
    description: "Xem danh sách vai trò và ma trận quyền",
  },
  {
    id: "roles.create",
    name: "Tạo vai trò",
    group_name: "Vai trò & Phân quyền",
    description: "Tạo vai trò mới cho tổ chức",
  },
  {
    id: "roles.update",
    name: "Cập nhật vai trò",
    group_name: "Vai trò & Phân quyền",
    description: "Đổi tên, mô tả và cấu hình vai trò",
  },
  {
    id: "roles.delete",
    name: "Xóa vai trò",
    group_name: "Vai trò & Phân quyền",
    description: "Xóa vai trò tùy chỉnh khỏi tổ chức",
  },
  {
    id: "roles.manage",
    name: "Quản lý ma trận phân quyền",
    group_name: "Vai trò & Phân quyền",
    description: "Tick/untick và lưu quyền cho các vai trò",
  },

  // ===== Tích điểm & Loyalty =====
  {
    id: "loyalty.view",
    name: "Xem cấu hình tích điểm",
    group_name: "Tích điểm & Loyalty",
    description: "Xem quy tắc tích điểm và lịch sử điểm khách hàng",
  },
  {
    id: "loyalty.configure",
    name: "Cấu hình tích điểm",
    group_name: "Tích điểm & Loyalty",
    description: "Thiết lập quy tắc tích / đổi điểm, hạng thành viên",
  },
  {
    id: "loyalty.redeem",
    name: "Đổi điểm thanh toán",
    group_name: "Tích điểm & Loyalty",
    description: "Áp dụng điểm tích lũy để thanh toán đơn hàng",
  },
  {
    id: "loyalty.adjust",
    name: "Điều chỉnh điểm thủ công",
    group_name: "Tích điểm & Loyalty",
    description: "Cộng / trừ điểm khách hàng thủ công kèm lý do",
  },
  {
    id: "loyalty.campaign.manage",
    name: "Quản lý chiến dịch loyalty",
    group_name: "Tích điểm & Loyalty",
    description: "Tạo và quản lý chiến dịch khuyến mãi tích điểm",
  },

  // ===== Tin nhắn Zalo =====
  {
    id: "zalo.view",
    name: "Xem tin nhắn Zalo",
    group_name: "Tin nhắn Zalo",
    description: "Xem lịch sử tin nhắn với khách qua Zalo",
  },
  {
    id: "zalo.send",
    name: "Gửi tin nhắn Zalo",
    group_name: "Tin nhắn Zalo",
    description: "Gửi tin nhắn chăm sóc khách qua Zalo",
  },
  {
    id: "zalo.configure",
    name: "Cấu hình Zalo OA",
    group_name: "Tin nhắn Zalo",
    description: "Cấu hình kết nối Zalo Official Account",
  },

  // ===== Trợ lý AI =====
  {
    id: "ai.chat",
    name: "Sử dụng trợ lý AI Chat",
    group_name: "Trợ lý AI",
    description: "Trò chuyện với trợ lý AI để hỏi đáp vận hành",
  },
  {
    id: "ai.voice",
    name: "Sử dụng trợ lý giọng nói",
    group_name: "Trợ lý AI",
    description: "Sử dụng AI giọng nói (TTS) trong cửa hàng",
  },
  {
    id: "ai.product_image",
    name: "Tạo ảnh sản phẩm bằng AI",
    group_name: "Trợ lý AI",
    description: "Sinh ảnh sản phẩm tự động bằng AI",
  },

  // ===== Đồng bộ offline =====
  {
    id: "sync.view",
    name: "Xem trạng thái đồng bộ",
    group_name: "Đồng bộ offline",
    description: "Xem trạng thái đồng bộ giữa thiết bị và server",
  },
  {
    id: "sync.manage",
    name: "Điều khiển đồng bộ offline",
    group_name: "Đồng bộ offline",
    description: "Kích hoạt / dừng / xử lý xung đột đồng bộ",
  },

  // ===== Cài đặt =====
  {
    id: "settings.business.view",
    name: "Xem thông tin doanh nghiệp",
    group_name: "Cài đặt",
    description: "Xem thông tin chung của doanh nghiệp / cửa hàng",
  },
  {
    id: "settings.business.update",
    name: "Cập nhật thông tin doanh nghiệp",
    group_name: "Cài đặt",
    description: "Chỉnh sửa thông tin, logo, mã số thuế",
  },
  {
    id: "settings.branches.manage",
    name: "Quản lý chi nhánh",
    group_name: "Cài đặt",
    description: "Tạo / sửa / xóa chi nhánh, quầy thu ngân",
  },
  {
    id: "settings.branch.update",
    name: "Cập nhật chi nhánh",
    group_name: "Cài đặt",
    description: "Cập nhật cấu hình chi nhánh",
  },
  {
    id: "settings.printers.manage",
    name: "Cấu hình máy in",
    group_name: "Cài đặt",
    description: "Cấu hình máy in hóa đơn, máy in bếp",
  },
  {
    id: "settings.printer.update",
    name: "Cập nhật máy in",
    group_name: "Cài đặt",
    description: "Cập nhật cấu hình máy in",
  },
  {
    id: "settings.billing.update",
    name: "Cập nhật thanh toán & gói dịch vụ",
    group_name: "Cài đặt",
    description: "Cập nhật cấu hình thanh toán, hóa đơn và gói dịch vụ",
  },
  {
    id: "settings.tax.manage",
    name: "Cấu hình thuế suất",
    group_name: "Cài đặt",
    description: "Thiết lập thuế suất và quy tắc tính thuế",
  },
  {
    id: "settings.payments.manage",
    name: "Cấu hình phương thức thanh toán",
    group_name: "Cài đặt",
    description: "Thiết lập phương thức thanh toán & ngân hàng",
  },
  {
    id: "settings.security.manage",
    name: "Cấu hình bảo mật",
    group_name: "Cài đặt",
    description: "Cấu hình 2FA, giới hạn IP, chính sách mật khẩu",
  },
  {
    id: "settings.integrations.manage",
    name: "Quản lý tích hợp",
    group_name: "Cài đặt",
    description: "Cấu hình tích hợp với bên thứ ba (Telegram, GHN, GHTK…)",
  },
  ...
  // ===== Nhật ký & Bảo mật =====
  {
    ...
    group_name: "Nhật ký & Bảo mật",
    description: "Xem audit log toàn hệ thống",
  },
  {
    id: "audit.export",
    name: "Xuất nhật ký hoạt động",
    group_name: "Nhật ký & Bảo mật",
    description: "Xuất audit log ra file để báo cáo / compliance",
  },
  {
    id: "security.sessions.manage",
    name: "Quản lý phiên đăng nhập",
    group_name: "Nhật ký & Bảo mật",
    description: "Xem và đóng phiên đăng nhập đang hoạt động",
  },
];
...
export const permissionService = {
  ...
  async getRoles(): Promise<Role[]> {
    ...
    try {
      const { data, error } = await supabase.from("roles").select("*").eq("organization_id", orgId);
  ...
  async assertCanManageRoles(requestedPermissionIds: string[] = []): Promise<void> {
    ...
    const canManage =
      isOwner || member.permissions.includes("roles.manage") || member.permissions.includes("staff.permissions.manage");
    if (!canManage) {
  ...
  async createRole(name: string, description: string, permissionIds: string[] = []): Promise<Role> {
    ...
    const { data, error } = await supabase.from("roles").insert([rolePayload]).select().single();
    ...
    if (error) {
      if (this.isTableMissingError(error)) {
        ...
        await this.createAuditLog(orgId, profileId, "role.create", {
          name,
          description,
  ...
  async updateRole(roleId: string, name: string, description: string, permissionIds: string[]): Promise<Role> {
    ...
    try {
      ...
      if (deleteError) {
        if (this.isTableMissingError(deleteError))
          return this.updateLocalRole(roleId, name, description, permissionIds);
        throw deleteError;
      }
      // Insert new ones
      if (permissionIds.length > 0) {
        ...
        if (insertError) {
          if (this.isTableMissingError(insertError))
            return this.updateLocalRole(roleId, name, description, permissionIds);
          throw insertError;
        }
      }
      ...
      await this.createAuditLog(orgId, profileId, "role.update", {
        role_id: roleId,
        name,
        permissions_count: permissionIds.length,
      });
  ...
  async getPermissions(): Promise<Permission[]> {
    ...
    try {
      ...
      for (const permission of data.map((item: any) => this.normalizePermission(item)))
        byId.set(permission.id, permission);
      return Array.from(byId.values()).sort(
        (a, b) => (a.sort_order ?? 0) - (b.sort_order ?? 0) || a.group_name.localeCompare(b.group_name),
      );
    } catch {
  ...
  getNormalizedDefaultPermissions(): Permission[] {
    return DEFAULT_PERMISSIONS.map((permission, index) =>
      this.normalizePermission({ ...permission, sort_order: index + 1 }),
    );
  },
  ...
  async getCurrentMemberRoleAndPermissions(): Promise<{ role: string; roleId: string | null; permissions: string[] }> {
    ...
    try {
      ...
      if (member.role_id) {
        ...
        const matchedDefaultKey =
          Object.keys(DEFAULT_ROLES_PERMISSIONS).find((k) => k.toLowerCase() === textRole.toLowerCase()) || "Owner";
  ...
  async assignStaffRole(employeeOrMemberId: string, roleId: string | null): Promise<boolean> {
    ...
    if (!isOwner) {
      const canManage =
        (await this.hasPermission("roles.manage")) ||
        (await this.hasPermission("staff.assign_role")) ||
        (await this.hasPermission("staff.permissions.manage"));
      if (!canManage) {
