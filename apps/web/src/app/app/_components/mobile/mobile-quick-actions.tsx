...
import { Plus, ScanBarcode, ArrowDownToLine, Tag, UserPlus, Sparkles, Search, Check } from "lucide-react";
          ...
          return (
            ...
            >
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-[9px] text-muted-foreground font-semibold leading-none truncate w-[88px]">
                  {act.desc}
                </p>
              </div>
            </button>
          ...
          <form onSubmit={handleStockInSubmit}>
            ...
            <div className="px-6 py-2 space-y-4">
              <div className="space-y-1.5">
                <Label htmlFor="stock-sku" className="text-xs font-bold text-muted-foreground uppercase">
                  Mã vạch hoặc SKU
                </Label>
              ...
              <div className="space-y-1.5">
                <Label htmlFor="stock-qty" className="text-xs font-bold text-muted-foreground uppercase">
                  Số lượng thêm
                </Label>
                <Input
                  id="stock-qty"
            ...
            <DrawerFooter className="px-6 gap-2 mt-4">
              <Button
                type="submit"
                className="h-12 text-sm font-bold w-full rounded-xl bg-primary text-primary-foreground"
              >
                Xác nhận cộng kho
              </Button>
              <DrawerClose asChild>
                <Button variant="outline" className="h-11 text-xs font-semibold w-full rounded-xl">
                  Hủy
                </Button>
              </DrawerClose>
            </DrawerFooter>
      ...
      <Drawer open={discountOpen} onOpenChange={setDiscountOpen}>
        <DrawerContent className="pb-8 bg-background">
          <form onSubmit={handleDiscountSubmit}>
            ...
            <div className="px-6 py-2 space-y-4">
              <div className="space-y-1.5">
                <Label htmlFor="promo-code" className="text-xs font-bold text-muted-foreground uppercase">
                  Mã code
                </Label>
                <Input
                  id="promo-code"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="promo-val" className="text-xs font-bold text-muted-foreground uppercase">
                  Mức giảm (%)
                </Label>
                <Input
                  id="promo-val"
      ...
      <Drawer open={customerOpen} onOpenChange={setCustomerOpen}>
        <DrawerContent className="pb-8 bg-background">
          <form onSubmit={handleCustomerSubmit}>
            ...
            <div className="px-6 py-2 space-y-4">
              <div className="space-y-1.5">
                <Label htmlFor="cust-name" className="text-xs font-bold text-muted-foreground uppercase">
                  Tên khách hàng
                </Label>
                <Input
                  id="cust-name"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="cust-phone" className="text-xs font-bold text-muted-foreground uppercase">
                  Số điện thoại
                </Label>
                <Input
                  id="cust-phone"
