  ...
  return (
    <div className="flex flex-col h-full bg-background pb-12 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col gap-3.5 border-b pb-4">
        <div className="mt-2">
          <h1 className="text-xl font-black tracking-tight text-foreground flex items-center gap-2">Quản lý tồn kho</h1>
          <p className="text-[10px] text-muted-foreground font-semibold uppercase tracking-wider">
            Cập nhật nhanh lượng hàng hoá thực tế
          </p>
        </div>
            ...
            <>
              <DrawerHeader className="text-left border-b pb-3 px-6">
                <div className="flex justify-between items-center mt-2">
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <div>
                      <DrawerTitle className="text-sm font-black truncate max-w-[200px]">
                        {selectedProduct.name}
                      </DrawerTitle>
                      <DrawerDescription className="text-[10px] text-muted-foreground font-mono">
                        SKU/Barcode: {selectedProduct.barcode || "N/A"}
                      </DrawerDescription>
                    </div>
                  </div>
                  <DrawerClose asChild>
              ...
              <div className="px-6 py-5 space-y-5">
                ...
                <div className="space-y-3.5">
                  <Label className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest leading-none block text-center">
                    Số lượng điều chỉnh
                  </Label>
                  ...
                  <div className="flex items-center justify-center gap-6">
                    ...
                    <span
                      className={`text-3xl font-black font-mono w-16 text-center leading-none ${adjustQty > 0 ? "text-emerald-600 dark:text-emerald-400" : adjustQty < 0 ? "text-destructive" : "text-foreground"}`}
                    >
