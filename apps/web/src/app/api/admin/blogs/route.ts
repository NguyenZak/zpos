      ...
      const initialBlogs = [
        {
          ...
          content:
            "Hệ thống POS (Point of Sale) đóng vai trò trung tâm của mọi hoạt động giao dịch tại quầy. Trong mùa mua sắm cao điểm cuối năm, lượng khách tăng đột biến có thể gây quá tải cho các hệ thống cũ kỹ. ZPOS với cấu trúc Offline-first và đồng bộ Realtime đảm bảo không gián đoạn bất kỳ giao dịch nào.",
        ...
        },
        {
          ...
          content:
            "Công nghệ Trợ lý ảo AI đang thay đổi cách thức các cửa hàng bán lẻ và quán cafe vận hành. Thay vì gõ phím chọn món thủ công, nhân viên chỉ cần nói tự nhiên. Voice AI của ZPOS sẽ tự động nhận diện ngôn ngữ, nhận dạng giọng nói tiếng Việt 3 miền cực tốt để phân tích và lên đơn tức thì dưới 1.5 giây.",
        ...
        },
        {
          ...
          content:
            "Khi doanh nghiệp mở rộng quy mô từ một cửa hàng lên chuỗi nhiều chi nhánh, thách thức lớn nhất là làm thế nào đồng bộ kho, giá cả và doanh thu đồng nhất. Với hệ sinh thái ZPOS, tất cả dữ liệu được lưu trữ tập trung tại cơ sở dữ liệu Supabase mạnh mẽ và phân phối cực nhanh qua kiến trúc biên CDN.",
  ...
  try {
    ...
    if (id) {
      ...
      blogs[index] = {
        ...
        coverImage:
          coverImage || "https://images.unsplash.com/photo-1432821596592-e2c18b78144f?auto=format&fit=crop&w=600&q=80",
